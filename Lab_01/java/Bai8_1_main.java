...
public class Bai8_1_main extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnThem.setOnClickListener(v -> {
            ...
            if (ten.isEmpty() || que.isEmpty() || gioiTinh.isEmpty()) {
                Toast.makeText(Bai8_1_main.this,"Vui lòng nhập đầy đủ thông tin",Toast.LENGTH_SHORT).show();
            } else {
                ...
                Toast.makeText(Bai8_1_main.this,"Thêm mới thành công " + ten,Toast.LENGTH_SHORT).show();
            }
        });

        btnIn.setOnClickListener(v -> {
            Intent intent = new Intent(Bai8_1_main.this, Bai8_1_list.class);
